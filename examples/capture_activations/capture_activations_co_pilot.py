...
parser.add_argument(
    ...
    type=str,
    default="positivedetections/meeting_test/aug_1_standup/hey_copilot",
    required=False
)
parser.add_argument(
    "--threshold",
...
parser.add_argument(
    ...
    type=str,
    default="/Users/SAI/Documents/Code/wakeWord/wakeWordForked/Untitled/wakeword_models/hey_co_pilot/hey_co_pilot_jul_25.onnx",
    required=False
)
parser.add_argument(
    "--inference_framework",
